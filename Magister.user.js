...
/*var P = false;
    if (!P){
       ...
       $("body").append('<div id = "dwj-tamper"><audio autoplay loop> <source src="https://github.com/NietVic/magister69/raw/main/erika.mp3" type="audio/mpeg"></audio></div>');
       P = true;
    }*/
